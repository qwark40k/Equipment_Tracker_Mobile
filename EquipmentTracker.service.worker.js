...
/** @type {string} */
const CACHE_VERSION = '1753986364|834729638';
/** @type {string} */
const CACHE_PREFIX = 'Equipment Tracke-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'EquipmentTracker.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["EquipmentTracker.html","EquipmentTracker.js","EquipmentTracker.offline.html","EquipmentTracker.icon.png","EquipmentTracker.apple-touch-icon.png","EquipmentTracker.audio.worklet.js","EquipmentTracker.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["EquipmentTracker.wasm","EquipmentTracker.pck"];
